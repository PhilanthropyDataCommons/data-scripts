...
| 7 | Last Payment Date | *no direct equivalent* — nearest `review_grant_agreement_date` | evaluation | string | ❌ Gap |
| 8 | Last Payment Amount | *no direct equivalent* — nearest `review_amount_recommended` | evaluation | string | ❌ Gap |
